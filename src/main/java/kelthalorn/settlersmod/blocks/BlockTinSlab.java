package kelthalorn.settlersmod.blocks;
...
public abstract class BlockTinSlab extends BlockSlab {
	...
	/**
	 * Only use if your block has multiple types, i.e {@link EnumHandler.ChipTypes}. If yours does not then just use what I put
	 */
	@Override
